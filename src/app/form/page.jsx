...
<div className="wFormContainer" style={{maxWidth: '90%', width: 'auto'}}>
  ...
  <div className><div className="wForm" id="3-WRPR" data-language="en_US" dir="ltr">
      ...
      <form method="post" action="https://cleanslatez.tfaforms.net/api_v2/workflow/processor" className="hintsBelow labelsAbove" id={3} role="form">
        ...
        <div className="oneField field-container-D    " id="tfa_36-D">
        ...
        <div className="oneField field-container-D     wf-acl-hidden" id="tfa_37-D">
          <label id="tfa_37-L" className="label preField " htmlFor="tfa_37">Salesforce contact record ID</label><br /><div className="inputWrapper"><input type="text" id="tfa_37" name="tfa_37" defaultValue title="Salesforce contact record ID" className /></div>
        </div>
        ...
        <input type="hidden" defaultValue={3} name="tfa_dbFormId" id="tfa_dbFormId" /><input type="hidden" defaultValue name="tfa_dbResponseId" id="tfa_dbResponseId" /><input type="hidden" defaultValue="556200e744f4a1403dac52c2e817634f" name="tfa_dbControl" id="tfa_dbControl" /><input type="hidden" defaultValue name="tfa_dbWorkflowSessionUuid" id="tfa_dbWorkflowSessionUuid" /><input type="hidden" defaultValue name="tfa_noOverWriteFields" id="tfa_noOverWriteFields" /><input type="hidden" defaultValue={70} name="tfa_dbVersionId" id="tfa_dbVersionId" /><input type="hidden" defaultValue name="tfa_switchedoff" id="tfa_switchedoff" />
      </form>
    </div></div>
  <div className="wFormFooter"><p className="supportInfo"><a target="new" className="contactInfoLink" href="https://cleanslatez.tfaforms.net/forms/help/3" data-testid="contact-info-link" /><br /></p></div>
